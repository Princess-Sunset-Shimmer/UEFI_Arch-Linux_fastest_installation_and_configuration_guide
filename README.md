...
by this step, you can install other packages such as ***dust, btop, vim, tmux, calc, gcc, cmatrix, fastfetch, wget, transmission-cli, elinks, cmus*** and whatever you need
- - - -
