...
`options` takes kernel parameters, replace `UUID=XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX` to your own `/` partition UUID witch you can find in previously generated ***fstab*** file
```c
        arch-chroot /mnt
        bootctl install
```
